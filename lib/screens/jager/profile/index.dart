...
class JagerProfileTab extends StatefulWidget {
  @override
  _JagerProfileTabState createState() => _JagerProfileTabState();
}

class _JagerProfileTabState extends State<JagerProfileTab> {
