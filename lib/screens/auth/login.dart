...
import 'package:otoranger/screens/auth/register.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> loginWithGoogle(BuildContext context) async {
    try {
      ...
      if (userRole == 'Jager - Pengguna') {
        // Jika role Jager, periksa apakah akun sudah terdaftar di Firestore
